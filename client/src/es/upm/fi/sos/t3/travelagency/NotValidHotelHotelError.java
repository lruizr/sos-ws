...
public class NotValidHotelHotelError extends java.lang.Exception{
    ...
    private es.upm.fi.sos.t3.travelagency.TravelAgencyWSStub.NotValidHotelHotelErrorMessage faultMessage;
    ...
    public void setFaultMessage(es.upm.fi.sos.t3.travelagency.TravelAgencyWSStub.NotValidHotelHotelErrorMessage msg){
       faultMessage = msg;
    }
    
    public es.upm.fi.sos.t3.travelagency.TravelAgencyWSStub.NotValidHotelHotelErrorMessage getFaultMessage(){
       return faultMessage;
    }
}
