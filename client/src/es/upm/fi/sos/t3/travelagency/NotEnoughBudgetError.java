...
public class NotEnoughBudgetError extends java.lang.Exception{
    ...
    private es.upm.fi.sos.t3.travelagency.TravelAgencyWSStub.NotEnoughBudgetErrorMessage faultMessage;
    ...
    public void setFaultMessage(es.upm.fi.sos.t3.travelagency.TravelAgencyWSStub.NotEnoughBudgetErrorMessage msg){
       faultMessage = msg;
    }
    
    public es.upm.fi.sos.t3.travelagency.TravelAgencyWSStub.NotEnoughBudgetErrorMessage getFaultMessage(){
       return faultMessage;
    }
}
