...
public class NotValidDestinationFlightError extends java.lang.Exception{
    ...
    private es.upm.fi.sos.t3.travelagency.TravelAgencyWSStub.NotValidDestinationFlightErrorMessage faultMessage;
    ...
    public void setFaultMessage(es.upm.fi.sos.t3.travelagency.TravelAgencyWSStub.NotValidDestinationFlightErrorMessage msg){
       faultMessage = msg;
    }
    
    public es.upm.fi.sos.t3.travelagency.TravelAgencyWSStub.NotValidDestinationFlightErrorMessage getFaultMessage(){
       return faultMessage;
    }
}
