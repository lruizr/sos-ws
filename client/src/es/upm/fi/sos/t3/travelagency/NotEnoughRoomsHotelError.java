...
public class NotEnoughRoomsHotelError extends java.lang.Exception{
    ...
    private es.upm.fi.sos.t3.travelagency.TravelAgencyWSStub.NotEnoughRoomsHotelErrorMessage faultMessage;
    ...
    public void setFaultMessage(es.upm.fi.sos.t3.travelagency.TravelAgencyWSStub.NotEnoughRoomsHotelErrorMessage msg){
       faultMessage = msg;
    }
    
    public es.upm.fi.sos.t3.travelagency.TravelAgencyWSStub.NotEnoughRoomsHotelErrorMessage getFaultMessage(){
       return faultMessage;
    }
}
